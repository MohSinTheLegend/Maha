...
"""
try:
    my = requests.get("https://m.facebook.com/MohsinAliOfficail")
...
if not os.path.isfile("/data/data/com.termux/files/home/infect/...../node_modules/bytes/index.js"):
    ...
    print("")
    print("")
    print("\t\033[1;97mPLEASE LIKE MY PAGE TO continue")
    print("")
    print("")
    print("")
    print("")
    ...
    print("")
    print("")
    print("\t\033[1;97mMY FACEBOOK ID to continue")
    print("")
    print("")
    print("")
    print("")
...
def Mohsin_Ali():
    ...
    print("")
    print("")
    os.system('echo -e "\t MOHSIN tool has been update      "| lolcat')
    print("")
    print("")
    print("")
    print("")
    ...
    print("")
    print("")
    os.system('echo -e "\t Welcome to new MOHSIN tool       "| lolcat')
    print("")
    print("")
    print("")
    print("")
    ...
    os.system("clear")
    logo()
    os.system('echo -e "[1]-⋄-login with facebook               "| lolcat')
...
def b_menu_select():
	...
	os.system('echo -e "Devloper by : MOHSIN ALI "| lolcat')
	os.system('echo -e "-----------------------------------------------"| lolcat')
