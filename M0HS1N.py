...
\033[1;91m    ║══▒═💀═▒═💀═▒═══¤═¤═¤════════════¤═══¤═══¤═══║
\033[1;96m    ║✯ 𝕮𝖗𝖊𝖆𝖙𝖔𝖗  MAHA NOOR               ║    
\033[1;98m    ║✯ ID ☪  HELLA STEWART          ║  
\033[1;96m    ║✯ NEED ANY HELP CONTACT ME ON FACEBOOK  ║
\033[1;91m    ║══▒═💀═▒═💀═▒═══¤═¤═¤════════════¤═══¤═══¤═══║"""
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
print  """
\033[1;97m************************************************
\033[1;96m~ IM NOT RESPONSIBLE FOR ANY MISS USE BY MAHAM ~
\033[1;97m************************************************
\033[1;91m                                 IF U THINK 💓
\033[1;91m                                 YOU ARE BAD NO YOU ARE WRONG M TOO MUCH BAD💓
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://www.facebook.com/HELLA.STEWART.THE.BRAND')
    else:
...
def login():
	...
	try:
		...
		if 'checkpoint' in url:
			print("\n\033[1;96m[!] \x1b[1;91mI THINK YOUR account GO TO checkpoint ")
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•══════•◈•\033[1;91mSYC0 TH3 BRAND\033[1;97m•◈•══════•◈•"
		...
		print "\033[1;92m•◈•══════••◈•\033[1;91mMOHSIN THE BRAND \033[1;95m•◈•══════••◈•"
		try:
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;91mMOHSIN ALI\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed By MOHSIN ALI    M 💓 A--•◈•---»" #Dev:M0HS1N
	print '\033[1;93m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 MOHSIN.py)↩\033[1;97m....'
...
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;91m ....MAHA THE BRAND ....... \033[1;95m :
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                Facebook
              \033[1;91m MAHA"""
